...
// Settings
include(SOURCEDIR.'/includes/klassen/settings.inc.php');
$settings = new Settings($mysql);
...
// IP2Country einbinden 
include(SOURCEDIR.'/includes/klassen/ip2country.inc.php');
...
function log_action($string) {
    ...
    p4c_query("INSERT INTO `employee_history` SET 
