...
$rs_movies = p4c_query("SELECT `id`, `file_id`, `merchant_id`, `actor_id`, `checksum`, `title`, `online_at`, `status`, `movie_language`, `category_master` FROM `movies` WHERE `movie_checked`='000-00-00 00:00:00' AND `released`='1' AND `convert_status` > '1' ORDER BY `id` DESC", __FILE__, __LINE__);
