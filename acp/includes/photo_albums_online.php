...
<div id="tabs">
    ...
    <div id="a">
        <div class="ui-widget-header" style="padding:10px; font-size:20px;">'.$count_photo_albums_online.' Fotoalben online</div>
        <div class="ui-widget-content" style="padding:10px; border-top:none; margin-bottom:20px;">
            Hier sind alle Fotoalben aufgelistet die in der Cloud ver&ouml;ffentlicht sind. 
        </div>
        ...
        // <![CDATA[
                ...
                oTable = jQuery("#table_photo_albums").dataTable({
                    ...
                    "bProcessing": true,
                    //"bServerSide": true,
                    "sAjaxSource": "'.ACP_URL.'/includes/ajax/photo_albums_online.php",
