    ...
    <table id="table_actor_movies" style="width:100%;">
        <thead>
            <tr>
                ...
                <th style="width:150px;">VerÃ¶ffentlichung</th>
...
while ($movie_obj = p4c_fetch_object($rs_actor_movies)) {
    if ($movie_obj->status == 'active') {
        ...
        $status_icon = '<img src="'.ACP_URL.'/images/icons/off.png" alt="" title="gelÃ¶scht" class="status" />';
    } else {
    ...
    if ($movie_obj->released == 0) {
        ...
        $released_status = ' <span style="font-size:10px; background:#ff9900; color:#fff; padding:2px 5px; border-radius:3px; margin-left:5px;">In PrÃ¼fung</span>';
