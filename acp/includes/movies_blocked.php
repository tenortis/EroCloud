...
<div id="tabs">
    ...
    <div id="a">
        <div class="ui-widget-header" style="padding:10px; font-size:20px;">'.$count_movies_blocked.' Filme sind gesperrt</div>
        <div class="ui-widget-content" style="padding:10px; border-top:none; margin-bottom:20px;">
            Hier sind alle Filme aufgelistet die gesperrt und nicht ver&ouml;ffentlicht wurden.
        </div>
        ...
        // <![CDATA[
        	jQuery(document).ready(function() {
            	...
            	oTable = jQuery("#table_movies").dataTable({
                    ...
                    "bProcessing": true,
                    //"bServerSide": true,
                    "sAjaxSource": "'.ACP_URL.'/includes/ajax/movies_blocked.php",
