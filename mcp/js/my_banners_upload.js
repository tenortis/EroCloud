jQuery(document).ready(function() {
    ...
    function show_banners(site_id) {
        jQuery.ajax({
            url: mcp_url+"/Ajax/webmaster_show_my_site_banners.php",
    ...
    jQuery("#form_upload_banners").ajaxForm({
        ...
        success: function(data) {
            ...
            if (data["jquery-upload-file-error"]) {
                ...
                //jQuery("#my_banners_popup_content .info_box").html("test");
                show_banners(site_id);
    ...
    var allowedImagesTypes = "jpg,jpeg,png,gif";
